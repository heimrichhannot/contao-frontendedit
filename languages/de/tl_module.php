...
$arrLang['addUpdateDeleteConditions']  			= array('Bedingungen für das Bearbeiten & Löschen hinzufügen', 'Wählen Sie hier aus, ob es Bedingungen für das Bearbeiten und Löschen von Datensätzen geben soll.');
$arrLang['updateDeleteConditions']  			= array(' ', 'Wählen Sie hier aus, unter welchen Bedingungen das Bearbeiten und Löschen von Datensätzen möglich sein soll.');
...
$arrLang['createBehavior']						= array('Verhalten beim Erstellen neuer Instanzen', 'Wählen Sie hier das Verhalten des Moduls aus, wenn eine neue Instanz erstellt wird.');
$arrLang['createBehavior']['create']			= 'Neue Instanz erstellen';
$arrLang['createBehavior']['create_until']		= 'Neue Instanz erstellen, sofern es noch keine gibt';
$arrLang['createBehavior']['redirect']			= 'Zu bestehender Instanz umleiten';
$arrLang['redirectId']							= array('Bestehende Instanz', 'Wählen Sie die Instanz zu der weitergeleitet werden soll, wenn kein ID-Parameter verfügbar ist..');
$arrLang['addExistingConditions']				= array('Instanz vorgeben', 'Wählen Sie diese Option aus, wenn die Instanz nicht über den GET-Parameter sondern über bestimmte Bedingungen gefunden werden soll.');
$arrLang['existingConditions']					= array('Bedingungen für das Auffinden bestehender Instanzen', 'Geben Sie hier Bedingungen ein, die für das Auffinden bestehender Instanzen gelten müssen.');
